...
ALTER TABLE user_settings ADD COLUMN public_post_instruction TEXT;
ALTER TABLE user_settings ADD COLUMN dm_post_instruction TEXT;
ALTER TABLE user_settings ADD COLUMN prototype_public_post_instruction TEXT;
ALTER TABLE user_settings ADD COLUMN prototype_dm_post_instruction TEXT;
